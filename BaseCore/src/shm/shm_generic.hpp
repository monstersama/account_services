...
class ShmGenericWriter {
public:
    ShmGenericWriter();
    ~ShmGenericWriter() noexcept;

    ShmGenericWriter(const ShmGenericWriter&) = delete;
    ShmGenericWriter& operator=(const ShmGenericWriter&) = delete;
    ShmGenericWriter(ShmGenericWriter&& other) noexcept;
    ShmGenericWriter& operator=(ShmGenericWriter&& other) noexcept;
...
class ShmGenericReader {
public:
    ShmGenericReader();
    ~ShmGenericReader() noexcept;

    ShmGenericReader(const ShmGenericReader&) = delete;
    ShmGenericReader& operator=(const ShmGenericReader&) = delete;
    ShmGenericReader(ShmGenericReader&& other) noexcept;
    ShmGenericReader& operator=(ShmGenericReader&& other) noexcept;
