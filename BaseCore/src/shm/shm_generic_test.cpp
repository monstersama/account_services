/**
 * shm_test: ShmGenericWriter / ShmGenericReader 功能测试
...
static bool test_account_name_overload() {
    ...
    shm::ShmGenericWriter::unlink(full_name);
    return true;
}
